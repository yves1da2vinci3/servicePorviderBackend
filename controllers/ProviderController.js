...
const getStats = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    reservations.forEach((reservation) => {
      ...
      totalReservationByMonth[month].reservationNumber +=
        totalReservationByMonth[month].reservationNumber + 1;
    });
    //  Payments
    // Get the current year
