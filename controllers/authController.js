...
const register = asyncHandler( async (req,res)=> {
    const {email,password,fullName,isServiceProvider,phoneNumber} = req.body
    ...
    try {
       ...
       await User.create({
        ...
        photoUrl  : `/uploads/users/${req.file.filename}`
       })
...
const editUser = asyncHandler( async (req,res)=> {
    ...
    try {
       ...
       user.phoneNumber = req.body.phoneNumber ? Number(phoneNumber)  : user.phoneNumber
